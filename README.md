...
suite covers 261 focused VBA corpus cases, 45 VB6 corpus cases, generated
...
vba/test/corpus/           261 VBA corpus cases
...
vb6/test/corpus/           45 VB6 corpus cases
...
Measured on 2026-09-25 with tree-sitter CLI 0.26.9:
...
| VBA corpus under `vba` | 261 of 261 cases; 481 of 481 example files without `ERROR` or `MISSING` |
| VB6 corpus cases under `vb6` | 45 of 45 |
| VBA corpus under `vb6` | 238 of 238 cases run, 23 skipped by design as listed above |
