...
suite covers 251 focused VBA corpus cases, 44 VB6 corpus cases, generated
...
vba/test/corpus/           251 VBA corpus cases
...
Measured on 2026-09-23 with tree-sitter CLI 0.26.9:
...
| VBA corpus under `vba` | 251 of 251 cases; 481 of 481 example files without `ERROR` or `MISSING` |
| VB6 corpus cases under `vb6` | 44 of 44 |
| VBA corpus under `vb6` | 228 of 228 cases run, 23 skipped by design as listed above |
