...
suite covers 250 focused VBA corpus cases, 44 VB6 corpus cases, generated
...
vba/test/corpus/           250 VBA corpus cases
...
Measured on 2026-09-22 with tree-sitter CLI 0.26.9:
...
| VBA corpus under `vba` | 250 of 250 cases; 481 of 481 example files without `ERROR` or `MISSING` |
| VB6 corpus cases under `vb6` | 44 of 44 |
| VBA corpus under `vb6` | 227 of 227 cases run, 23 skipped by design as listed above |
